...
titanic<-read.csv("C:/Users/17293/Desktop/大二下/数据分析/Exercise1/train.csv")
#查看数据
...
trainid <- createDataPartition(base$PassengerId, p = 0.75, list = F)
 ...
 train<-read.csv("C:/Users/17293/Desktop/大二下/数据分析/Exercise1/train.csv")
 test<-read.csv("C:/Users/17293/Desktop/大二下/数据分析/Exercise1/test.csv")
...
ggplot(data = OOB, aes(x = tree))+geom_line(aes(y = OOB), colour = "black", linewidth = 0.8)+geom_line(aes(y = X0), colour = "red", linewidth = 0.8)+geom_line(aes(y = X1), colour = "green", linewidth = 0.8) + labs(y = "Error.rate") + theme_bw()

#过程5：测试、预测与修正
test<-read.csv("C:/Users/17293/Desktop/大二下/数据分析/Exercise1/train.csv")#test datsets,test3
...
```
```{r github}
#git@github.com:Altheac297/R-project-for-DA-course.git
```